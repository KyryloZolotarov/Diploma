...
public class CatalogServiceTest
{
    ...
    public async Task GetCatalogSubTypesAsync_ReturnsCatalogSubTypeFailed()
    {
        ...
        catalogItemRepositoryMock.Setup(h => h.GetSubTypesAsync(0))
            .Returns((Func<IEnumerable<CatalogSubTypeDto>>)null!);
    ...
    public async Task GetListCatalogItemsAsync_Successfully()
    {
        ...
        var basketItemsMock = new List<BasketItemDto> { new () { Id = 1, Count = 1 } };

        var itemsForBasket = new ItemsForBasketRequest
            { Items = new List<BasketItemDto> { new () { Id = 1, Count = 1 } } };
        ...
        var listItemsToFront = new BasketItems<CatalogItemDto>
            { Items = new List<CatalogItemDto> { catalogItemDtoSuccess } };
        ...
        catalogItemRepositoryMock.Setup(h => h.GetItemsListAsync(It.IsAny<List<BasketItemDto>>()))
            .ReturnsAsync(listItemsFromBase);
    ...
    public async Task ChangeAvailableItems_Successfully()
    {
        ...
        catalogItemRepositoryMock.Setup(h => h.ChangeAvailableItems(It.IsAny<int>(), It.IsAny<int>()))
            .ReturnsAsync(resultSucces);
