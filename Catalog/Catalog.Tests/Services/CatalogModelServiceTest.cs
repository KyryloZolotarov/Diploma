...
public class CatalogModelServiceTest
{
    ...
    public async Task AddModelAsync_ReturnsIntSuccessfully()
    {
        ...
        var catalogModelService = new CatalogModelService(
            dbContextWrapperMock.Object,
            loggerMock.Object,
            catalogModelRepositoryMock.Object);
    ...
    public async Task UpdateModelAsync_ReturnsIntSuccessfully()
    {
        ...
        catalogModelRepositoryMock.Setup(h => h.Update(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<int>()))
            .ReturnsAsync(id);
        var catalogModelService = new CatalogModelService(
            dbContextWrapperMock.Object,
            loggerMock.Object,
        ...
        Assert.NotNull(result);
        Assert.Equal(id, result!.Value);
        catalogModelRepositoryMock.Verify(
            x => x.Update(
                It.IsAny<int>(),
                It.IsAny<string>(),
                It.IsAny<int>()),
