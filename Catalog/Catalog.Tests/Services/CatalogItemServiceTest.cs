...
namespace Catalog.Tests.Services
{
    public class CatalogItemServiceTest
    {
        ...
        public async Task AddItemAsync_ReturnsCatalogItemSuccessfully()
        {
            ...
            catalogItemRepositoryMock.Setup(h => h.Add(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<decimal>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>())).ReturnsAsync(id);
            var catalogItemService = new CatalogItemService(dbContextWrapperMock.Object, loggerMock.Object, catalogItemRepositoryMock.Object);
            ...
            catalogItemRepositoryMock.Verify(x => x.Add(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<decimal>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>()), Times.Once());
        }
        ...
        public async Task UpdateItemAsync_ReturnsCatalogItemSuccessfully()
        {
            ...
            catalogItemRepositoryMock.Setup(h => h.Update(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<decimal>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>())).ReturnsAsync(id);
            var catalogItemService = new CatalogItemService(dbContextWrapperMock.Object, loggerMock.Object, catalogItemRepositoryMock.Object);
            ...
            Assert.NotNull(result);
            Assert.Equal(id, result!.Value);
            catalogItemRepositoryMock.Verify(x => x.Update(It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<decimal>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>()), Times.Once());
        }
