...
namespace Order.Tests.Services
{
    public class OrderServiceTest
    {
        ...
        public async Task AddOrder_Successful()
        {
            ...
            var listItemsSuccess = new ListItemsForFrontRequest() { Items = new List<OrderItemDto>() { new OrderItemDto() { Id = 1, Count = 1, Name = "Part" } } };
            ...
            mockOrderOrderRepository.Setup(h => h.AddOrder(It.IsAny<OrderUserDto>(), It.IsAny<ListItemsForFrontRequest>())).ReturnsAsync(addingSuccess);
            var orderService = new OrderService(dbContextWrapperMock.Object, loggerMock.Object, mockOrderOrderRepository.Object, mapperMock.Object);

            var result = await orderService.AddOrder(userDtoSuccess, listItemsSuccess);
            Assert.True(result);
            mockOrderOrderRepository.Verify(x => x.AddOrder(It.IsAny<OrderUserDto>(), It.IsAny<ListItemsForFrontRequest>()), Times.Once());
        }
        ...
        public async Task AddOrder_Failed()
        {
            ...
            var listItemsFailed = new ListItemsForFrontRequest() { Items = new List<OrderItemDto>() { new OrderItemDto() { Id = 1, Count = 1, Name = "Part" } } };
            ...
            mockOrderOrderRepository.Setup(h => h.AddOrder(It.IsAny<OrderUserDto>(), It.IsAny<ListItemsForFrontRequest>())).ReturnsAsync(addingFailed);
            var orderService = new OrderService(dbContextWrapperMock.Object, loggerMock.Object, mockOrderOrderRepository.Object, mapperMock.Object);
        ...
        public async Task GetOrder_Successful()
        {
            ...
            var orderSuccess = new OrderOrderForFrontResponse() { Order = new OrderOrderDto() { UserId = "fwewd", DateTime = DateTime.Now, Id = 1 } };
            var orderFromBaseSuccess = new OrderOrderResponse() { Order = new OrderOrderEntity() { UserId = "fwewd", DateTime = DateTime.Now, Id = 1 } };
