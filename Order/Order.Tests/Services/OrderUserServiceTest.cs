    ...
    public class OrderUserServiceTest
    {
        ...
        public async Task Add_Successful()
        {
            ...
            mockOrderUserRepository
                .Setup(repo => repo.Add(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
                .ReturnsAsync(returnID);

            var orderUserService = new OrderUserService(dbContextWrapperMock.Object, loggerMock.Object, mockOrderUserRepository.Object);
            ...
            mockOrderUserRepository.Verify(x => x.Add(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()), Times.Once());
        }
        ...
        public async Task Add_Failure()
        {
            ...
            await Assert.ThrowsAsync<BusinessException>(() => orderUserService.Add("12423", "12423", "12423", "12423", "12423", "12423"));
        }
        ...
        public async Task Update_Successful()
        {
            ...
            mockOrderUserRepository
                .Setup(repo => repo.Update(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()))
                .ReturnsAsync(returnID);
            ...
            mockOrderUserRepository.Verify(x => x.Update(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>()), Times.Once());
        }
        ...
        public async Task Update_Failure()
        {
            ...
            await Assert.ThrowsAsync<BusinessException>(() => orderUserService.Update("12423", "12423", "12423", "12423", "12423", "12423"));
        }
