...
namespace Order.Tests.Services
{
    public class OrderOrderServiceTest
    {
        ...
        public async Task Add_Successful()
        {
            ...
            var orderItemService = new OrderOrderService(dbContextWrapperMock.Object, loggerMock.Object, mockOrderOrderRepository.Object);
        ...
        public async Task Add_Failure()
        {
            ...
            var orderOrderService = new OrderOrderService(dbContextWrapperMock.Object, loggerMock.Object, mockOrderOrderRepository.Object);
